...
// 	scores[2] = 99
// 	fmt.Println("Array after index 2: ", scores)
// 	fmt.Println("LengthL: ", len(scores))
...
// 	task := []string{"Write tests", "Deploy app", "Review PR"}
...
// func filterDone(tasks2 []Task) []Task {
// 	var doneTasks []Task
// 	doneTaskSlice := doneTasks[:]
// 	for _, t := range tasks2 {
// 		if t.Done == true {
// 			doneTaskSlice = append(doneTaskSlice, t)
// 		}
// 	}
// 	return doneTaskSlice
// }
