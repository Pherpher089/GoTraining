...
func main() {
	...
	fmt.Println("CreatedAt: ", task.Done)
	...
	fmt.Println("Go auto-dereferences: ", p4.Title, " <- no need for (*p4).Title")
	...
	// Your code here...
	updatePriority(&t4, High)

	fmt.Println("New priority: ", t4.Priority)

	fmt.Println()
	fmt.Println("=== Done! Check the answers section below ===")
}

func updatePriority(task *Task, priority Priority) {
