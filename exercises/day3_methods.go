...
func main() {
	...
	// t2.AddTag("backend")
	// t2.AddTag("urgent")
	// fmt.Println("Tags after AddTag:", t2.Tags)

	// TODO: Call t2.HasTag("urgent") and t2.HasTag("frontend"), print both
	// fmt.Println("HasTag \"urgent\":", t2.HasTag("urgent"))
	// fmt.Println("HasTag \"frontend\":", t2.HasTag("frontend"))
	...
	// fmt.Println("high is valid:", High.IsValid())
	// fmt.Println("urgent is valid:", Priority("urgent").IsValid())

	// TODO: Call Label() on High and Medium, print results
	// fmt.Println("High label:", High.Label())
	// fmt.Println("Medium label:", Medium.Label())
	...
	// t3 := store.Add(Task{Title: "Write tests", Priority: High})
	// t4 := store.Add(Task{Title: "Fix bug", Priority: Low})
	// fmt.Println("Added:", t3.String())
	// fmt.Println("Added:", t4.String())

	// TODO: Call GetAll(), print the count and each task
	// all := store.GetAll()
	// fmt.Println("All tasks:", len(all))
	// for _, t := range all {
	// 	fmt.Printf("  [%d] %s (%s) done: %v\n", t.ID, t.Title, t.Priority, t.Done)
	// }

	// TODO: Call GetByID(1) and GetByID(99), print results
	// found, ok := store.GetByID(1)
	// fmt.Println("Found by ID 1:", found.Title)
	// _, ok = store.GetByID(99)
	// fmt.Println("ID 99 found:", ok)
